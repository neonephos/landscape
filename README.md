...
![NeoNephos Landscape Logo](https://raw.githubusercontent.com/neonephos/artwork/df8258a3e902ba98e9ceccde30d0a4e568f58319/other/neonephos_foundation/horizontal/color/neonephos_horizontal_color.svg)

This landscape is intended as a map to explore open source projects hosted by NeoNephos and also shows its sponsoring organizations. It is modeled after the Cloud Native Computing Foundation (CNCF) [landscape](https://landscape.cncf.io) and based on the same open-source code.

This repository contains the data files and images required to generate the [NeoNephos landscape](https://landscape.neonephos.org). The software that generates it can be found at the [cncf/landscape2](https://github.com/cncf/landscape2) repository. Please see its [README file](https://github.com/cncf/landscape2#landscape2) for more information about how it works.
...
If you cannot access the above resources, please [create a helpdesk ticket](https://helpdesk.linuxfoundation.org) to request those changes.
...
```shell
landscape2 build --data-file landscape.yml --settings-url https://raw.githubusercontent.com/cncf/landscape2-sites/refs/heads/main/neonephos/settings.yml --logos-path hosted_logos --output-dir build
