...
```shell
landscape2 build --data-file data.yml --settings-url https://raw.githubusercontent.com/lfeurope/landscape2-sites/refs/heads/main/neonephos/settings.yml --logos-path logos --output-dir build
